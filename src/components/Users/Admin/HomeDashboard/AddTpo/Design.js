...
const AddTpoDesign = ({ navigation, departmentlist, submitAccount, validateFirstName, validateLastName, validateEmail,
    validateMobile, validateBranch, validatePassword, validatePassConf, validatePasswordChecker, formClear
                        ...
                        <View style={styles.activityListView}>
                            ...
                            <View style={styles.submitButton} >
                                <Button
                                    ...
                                    mode="contained"
                                    onPress={() => {
                                        submitAccount(firstName, lastName, email, mobile, selectedDepartment, password, passConf);
                                        checkFirstName(firstName);
                                        checkLastName(lastName);
                                        checkEmail(email);
                                        checkMobile(mobile);
                                        checkBranch(selectedDepartment);
                                        checkPassword(password);
                                        checkPassConf(passConf);
    ...
    function formDataClear(allow) {
        if (submitAccount(firstName, lastName, email, mobile, selectedDepartment, password, passConf)) {
            setFirstName('');
            setLastName('');
            setEmail('');
            setMobile('');
